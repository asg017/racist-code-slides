...
---
<Title number={1}>Use racist <Appear order={1} startValue={{display:'none'}}><span style={{color:'#f5ab35'}}>(or not diverse)</span></Appear> data</Title>
...
<Title number={2}>Don't consider all users</Title>
