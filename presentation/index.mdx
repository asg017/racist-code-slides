...
> Fraud and similarity detection software, as well as input from universities, are used when deciding whether an application needs investigating.
...
arrest	in	81	to	86 percent	of	name	searches	on	one	website	and	92 to	95	percent	on
...
percent	of	name	searches	on	one	site	and	0	to	60	percent	on	the	other

[Paper](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=2208240)
<Site/>
